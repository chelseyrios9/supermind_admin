...
const SupermindBackend = () => {
  ...
  2. 'taskPrompt' - a pseudocode representation that explains how to accomplish the task. If you are setting the RAG flag then make sure the prompt works as a RAG query.
