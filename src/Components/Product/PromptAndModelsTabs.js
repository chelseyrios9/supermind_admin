...
import Switch from "../CommonComponent/Switch/Switch";
...
const LLMTool = () => {
  ...
  return (
    <div>
      ...
      />
      <div
        className={"flex flex-column w-100 m-auto overflow-hidden border border-black"}
      >
        <div
        ...
        >
          <div className="d-flex text-center" style={{width: "17%"}}>
            <Btn
              className="btn-sm border border-black w-100 btn-primary"
        ...
        <div className={"flex grow"}>
          <div className={"shrink-0 contents"} style={{ width: fileW - 730 }}>
            <div
